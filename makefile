PROJECT_NAME		:=	RFLU
# MCU param.
MK_FLAGS			:=	-mcpu=cortex-m3 
MK_FLAGS			+=	-mthumb
MK_FLAGS			+=	-mfloat-abi=soft
...
# Linker.
LD_FILES			:=	-T submodule/module_stm32f1_low_level/LD/STM32F103XB_FLASH.ld
STARTUPE_S_NAME		:=	submodule/module_stm32f1_low_level/startupe/startup_stm32f103xb.s
