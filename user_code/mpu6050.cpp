...
static void mpu6050_cfg(mpu6050_t *d){
    ...
    MPU6050_WriteBits(d, MPU6050_DEFAULT_ADDRESS, MPU6050_RA_INT_ENABLE, MPU6050_INTERRUPT_DATA_RDY_BIT, 1, 1);
    //Включим рабочий режим
    MPU6050_WriteBits(d, MPU6050_DEFAULT_ADDRESS, MPU6050_RA_PWR_MGMT_1, MPU6050_PWR1_SLEEP_BIT,1, 0);
